...
const purchaseOrderList = [
  ...
  {
    id: 2,
    purchaseOrderCode: "PO16250805005203",
    companyName: "Efox Technologies Pvt Ltd",
    status: "Confirmed",
    contactPerson: "Yogesh Duvedi",
    contactNo: "9720028787",
    purchaseOrderDate: "05 Aug 2025",
  ...
  // Add more dummy purchase order data as needed
];
...
const columnDefs = [
    ...
    cellRenderer: (params) => {
      ...
      return (
        <button
          ...
          onClick={(e) => {
            e.stopPropagation();
            navigate(`/purchase-order/view/${params.data.id}`);
          }}
        >
          {params.value}
        </button>
  ...
  { headerName: "PurchaseOrder Date", field: "purchaseOrderDate", flex: 1, filter: true },
